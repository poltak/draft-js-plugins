...
var _style = {
  "unfocused": "draftJsEmojiPlugin__unfocused__1Wvrs",
...
exports.default = function () {
  ...
  var blockTypes = config.types ? config.types : ['atomic'];
  var onRemove = config.onRemove ? config.onRemove : function () {};
  ...
  return {
    ...
    keyBindingFn: function keyBindingFn(evt, _ref) {
      ...
      if (evt.keyCode === 39) {
        ...
        var notAtomicAndLastPost = !blockTypes.includes(currentBlock.getType()) && currentBlock.getLength() === _selection.getFocusOffset();
      ...
      if ([46, 8].includes(evt.keyCode) && focusableBlockIsSelected(editorState, blockKeyStore)) {
        setEditorState((0, _removeBlock2.default)({ getEditorState: getEditorState }, editorState.getSelection().getFocusKey()));
      }
    },
    ...
    blockRendererFn: function blockRendererFn(contentBlock, _ref2) {
      ...
      var isFocused = (0, _blockInSelection2.default)(editorState, blockKey);
