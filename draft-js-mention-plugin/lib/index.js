...
exports.default = function () {
  ...
  var _config$mentionPrefix = config.mentionPrefix,
      ...
      _config$maxSuggestion = config.maxSuggestionsCharacters,
      maxSuggestionsCharacters = _config$maxSuggestion === undefined ? 20 : _config$maxSuggestion;
  ...
  return {
    ...
    decorators: [{
      ...
      strategy: (0, _mentionSuggestionsStrategy2.default)(mentionTrigger, mentionRegExp, supportWhitespace, maxSuggestionsCharacters),
